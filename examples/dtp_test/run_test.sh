...
TIME=$(date +"%m%d-%H%M%S")
DIR_NAME="logs/${TRACE_FILE_BASENAME}-${TIME}"
TC_LOG="${DIR_NAME}/${TC_LOG:-tc.log}"
SERVER_LOG="${DIR_NAME}/${SERVER_LOG:-server.log}"
COUNT=0
CLIENT_LOG="${DIR_NAME}/${CLIENT_LOG:-client}-${TRACE_FILE_BASENAME}"
